				...
				<div className="max-w-4xl mx-auto text-center">
					<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
						...
						<p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto px-4">
							Controle suas finanças com linguagem natural. Registre despesas via WhatsApp, acompanhe o caixa em tempo
							real, veja seu saldo restante e receba sugestões inteligentes sem planilhas.
						</p>
				...
				<div className="container mx-auto px-4">
					<div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 text-center sm:text-left">
						...
						<p className="text-sm text-muted-foreground">
							© {new Date().getFullYear()} {branding.brandName}. Seu contador digital conversacional.
						</p>
					</div>
				</div>
			</footer>
